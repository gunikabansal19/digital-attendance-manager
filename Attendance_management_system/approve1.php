<?php
 ...
 $query = $mysqli->query("INSERT INTO student (firstname,lastname,email,id,password,gender) VALUES ('$name1','$name2','$email','$id','$password','$gender'); ");  

 if($query)                                                                                               //check if value inserted then delete row from local table1
 {   
       $mysqli->query("DELETE FROM table1 where email='$email1' "); 
	    header("location: unapprovedstudents1.php");
 }
